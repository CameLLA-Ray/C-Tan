  ...
  <div>
    <el-form :model="emissionList">
      <el-form-item label="*产品类型">
        <el-input v-model="emissionList.productType" placeholder="请输入产品类型"></el-input>
      </el-form-item>
      <el-row :gutter="1">
        <el-col :span="8">
          <el-form-item label="*产品名称">
            <el-input v-model="emissionList.product" placeholder="请填写"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8" :offset="8">
          <el-form-item label="*产品型号">
            <el-input v-model="emissionList.version" placeholder="请填写"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="1">
        <el-col :span="8">
          <el-form-item label="*产品描述">
            <el-input v-model="emissionList.description" placeholder=""></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8" :offset="8">
          <el-form-item label="*是否公开">
            <el-select v-model="emissionList.isPublic" placeholder="">
              <el-option
